/**
 * Runtime endpoint resolution for inventory_mfe.
 *
...
const API_PATH = "/api/inventory-storage";
const DEV_API_BASE = "http://localhost:8082";

export function resolveInventoryApiBase(
...
export const INVENTORY_API_BASE = resolveInventoryApiBase(
