...
// inventory-mfe: the inventory-storage remote. Exposes ./App -- the shell
// lazy-loads it at /inventory/*. Also runnable standalone on :5182 for
...
// http://localhost/mfes/inventory-storage/, so every hashed chunk and the
...
const PUBLIC_BASE = IS_BUILD ? "/mfes/inventory-storage/" : "/";
