# Makefile — the local quality gate for inventory-storage.
#
...
MUTATION_FAST_PKG  := ./internal/domain/stock
...
help:
	@echo "inventory-storage — local quality gate (targets mirror .github/workflows/ci.yml)"
	@echo ""
